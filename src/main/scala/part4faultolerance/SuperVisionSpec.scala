...
import part4faultolerance.SuperVisionSpec._
...
class SuperVisionSpec extends TestKit(ActorSystem("superVisionSpec"))
  ...
  "A supervisor" should {
    "resume its child in case of a minor fault" in {
      ...
      child ! "sadadadadadladkladnaldnadlandaldnadlnadaldnaldansadas"
      child ! Report
      expectMsg(3)
    }
  ...
  class FussyWordCounter extends Actor {
    ...
    override def receive: Receive = {
      ...
      case sentence: String =>
        ...
        else if (!Character.isUpperCase(sentence(0))) throw new IllegalArgumentException("sentence must start with " +
          "uppercase")
